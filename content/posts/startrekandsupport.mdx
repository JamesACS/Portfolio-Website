...
In the past, this has been as simple as arranging 1-1 meetings with colleagues, or setting up shadowing opportunities in other domains. More often than not I found that team members returned from these experiences not only with more motivation, but wanting to spend more time in Support! 
